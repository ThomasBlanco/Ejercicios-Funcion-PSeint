...
Funcion edad <- CalcularEdad(diaN, mesN, anioN, diaA, mesA, anioA)
    Definir edad, ajustar Como Entero
    
    // edad inicial
    edad <- anioA - anioN
    
    // condición lógica: 1 si aún no cumplió, 0 si ya cumplió
    ajusta <- (mesA < mesN) O (mesA = mesN Y diaA < diaN)
    
    // restar ese 1 o 0 sin usar IF
    edad <- edad - ajustar
FinFuncion
